...
| [URLScan.io](https://urlscan.io/about-api/) | Scan and Analyse URLs | apiKey | True | unknown |
...
| [Storj](https://docs.storj.io/dcs/) | Decentralized Open-Source Cloud Storage | apiKey | True | unknown |
...
| [Covid-19 Live Data](https://github.com/mathdroid/covid-19-api) | Global and countrywise data of Covid 19 daily Summary, confirmed cases, recovered and deaths |  | True | yes |
| [Covid-19 Philippines](https://github.com/Simperfy/Covid-19-API-Philippines-DOH) | Unofficial Covid-19 Web API for Philippines from data collected by DOH |  | True | yes |
| [COVID-19 Tracker Canada](https://api.covid19tracker.ca/docs/1.0/overview) | Details on Covid-19 cases across Canada |  | True | unknown |
| [COVID-19 Tracker Sri Lanka](https://www.hpb.health.gov.lk/en/api-documentation) | Provides situation of the COVID-19 patients reported in Sri Lanka |  | True | unknown |
| [COVID-ID](https://data.covid19.go.id/public/api/prov.json) | Indonesian government Covid data per province |  | True | yes |
| [Dataflow Kit COVID-19](https://covid-19.dataflowkit.com) | COVID-19 live statistics into sites per hour |  | True | unknown |
| [FoodData Central](https://fdc.nal.usda.gov/) | National Nutrient Database for Standard Reference | apiKey | True | unknown |
| [Healthcare.gov](https://www.healthcare.gov/developers/) | Educational content about the US Health Insurance Marketplace |  | True | unknown |
| [Humanitarian Data Exchange](https://data.humdata.org/) | Humanitarian Data Exchange (HDX) is open platform for sharing data across crises and organisations |  | True | unknown |
| [Infermedica](https://developer.infermedica.com/docs/) | NLP based symptom checker and patient triage API for health diagnosis from text | apiKey | True | yes |
| [LAPIS](https://cov-spectrum.ethz.ch/public) | SARS-CoV-2 genomic sequences from public sources |  | True | yes |
| [Lexigram](https://docs.lexigram.io/) | NLP that extracts mentions of clinical concepts from text, gives access to clinical ontology | apiKey | True | unknown |
| [Makeup](http://makeup-api.herokuapp.com/) | Makeup Information |  | False | unknown |
| [MyVaccination](https://documenter.getpostman.com/view/16605343/Tzm8GG7u) | Vaccination data for Malaysia |  | True | unknown |
| [NPPES](https://npiregistry.cms.hhs.gov/registry/help-api) | National Plan & Provider Enumeration System, info on healthcare providers registered in US |  | True | unknown |
| [Nutritionix](https://developer.nutritionix.com/) | Worlds largest verified nutrition database | apiKey | True | unknown |
| [Open Data NHS Scotland](https://www.opendata.nhs.scot) | Medical reference data and statistics by Public Health Scotland |  | True | unknown |
| [Open Disease](https://disease.sh/) | API for Current cases and more stuff about COVID-19 and Influenza |  | True | yes |
| [openFDA](https://open.fda.gov) | Public FDA data about drugs, devices and foods | apiKey | True | unknown |
| [Orion Health](https://developer.orionhealth.io/) | Medical platform which allows the development of applications for different healthcare scenarios | OAuth | True | unknown |
| [Quarantine](https://quarantine.country/coronavirus/api/) | Coronavirus API with free COVID-19 live updates |  | True | yes |
...
| [DevITjobs UK](https://devitjobs.uk/job_feed.xml) | Jobs with GraphQL |  | True | yes |
| [Findwork](https://findwork.dev/developers/) | Job board | apiKey | True | unknown |
| [GraphQL Jobs](https://graphql.jobs/docs/api/) | Jobs with GraphQL |  | True | yes |
| [Jobs2Careers](http://api.jobs2careers.com/api/spec.pdf) | Job aggregator | apiKey | True | unknown |
| [Jooble](https://jooble.org/api/about) | Job search engine | apiKey | True | unknown |
| [Juju](http://www.juju.com/publisher/spec/) | Job search engine | apiKey | False | unknown |
| [Open Skills](https://github.com/workforce-data-initiative/skills-api/wiki/API-Overview) | Job titles, skills and related jobs data |  | False | unknown |
| [Reed](https://www.reed.co.uk/developers) | Job board aggregator | apiKey | True | unknown |
| [The Muse](https://www.themuse.com/developers/api/v2) | Job board and company profiles | apiKey | True | unknown |
| [Upwork](https://developers.upwork.com/) | Freelance job board and management system | OAuth | True | unknown |
| [USAJOBS](https://developer.usajobs.gov/) | US government job board | apiKey | True | unknown |
| [WhatJobs](https://www.whatjobs.com/affiliates) | Job search engine | apiKey | True | unknown |
| [ZipRecruiter](https://www.ziprecruiter.com/publishers) | Job search app and website | apiKey | True | unknown |
...
| [Irisnet](https://irisnet.de/api/) | Realtime content moderation API that blocks or blurs unwanted images in real-time | apiKey | True | yes |
| [Keen IO](https://keen.io/) | Data Analytics | apiKey | True | unknown |
| [Machinetutors](https://www.machinetutors.com/portfolio/MT_api.html) | AI Solutions: Video/Image Classification & Tagging, NSFW, Icon/Image/Audio Search, NLP | apiKey | True | yes |
| [MessengerX.io](https://messengerx.rtfd.io) | A FREE API for developers to build and monetize personalized ML based chat apps | apiKey | True | yes |
| [NLP Cloud](https://nlpcloud.io) | NLP API using spaCy and transformers for NER, sentiments, classification, summarization, and more | apiKey | True | unknown |
| [OpenVisionAPI](https://openvisionapi.com) | Open source computer vision API based on open source models |  | True | yes |
| [Perspective](https://perspectiveapi.com) | NLP API to return probability that if text is toxic, obscene, insulting or threatening | apiKey | True | unknown |
| [Roboflow Universe](https://universe.roboflow.com) | Pre-trained computer vision models | apiKey | True | yes |
| [SkyBiometry](https://skybiometry.com/documentation/) | Face Detection, Face Recognition and Face Grouping | apiKey | True | unknown |
| [Time Door](https://timedoor.io) | A time series analysis API | apiKey | True | yes |
| [Unplugg](https://unplu.gg/test_api.html) | Forecasting API for timeseries data | apiKey | True | unknown |
| [WolframAlpha](https://products.wolframalpha.com/api/) | Provides specific answers to questions using data and algorithms | apiKey | True | unknown |
...
| [Bandsintown](https://app.swaggerhub.com/apis/Bandsintown/PublicAPI/3.0.0) | Music Events |  | True | unknown |
| [Deezer](https://developers.deezer.com/api) | Music | OAuth | True | unknown |
| [Discogs](https://www.discogs.com/developers/) | Music | OAuth | True | unknown |
| [Freesound](https://freesound.org/docs/api/) | Music Samples | apiKey | True | unknown |
| [Gaana](https://github.com/cyberboysumanjay/GaanaAPI) | API to retrieve song information from Gaana |  | True | unknown |
| [Genius](https://docs.genius.com/) | Crowdsourced lyrics and music knowledge | OAuth | True | unknown |
| [Genrenator](https://binaryjazz.us/genrenator-api/) | Music genre generator |  | True | unknown |
| [iTunes Search](https://affiliate.itunes.apple.com/resources/documentation/itunes-store-web-service-search-api/) | Software products |  | True | unknown |
| [Jamendo](https://developer.jamendo.com/v3.0/docs) | Music | OAuth | True | unknown |
| [JioSaavn](https://github.com/cyberboysumanjay/JioSaavnAPI) | API to retrieve song information, album meta data and many more from JioSaavn |  | True | unknown |
| [KKBOX](https://developer.kkbox.com) | Get music libraries, playlists, charts, and perform out of KKBOX's platform | OAuth | True | unknown |
| [KSoft.Si Lyrics](https://docs.ksoft.si/api/lyrics-api) | API to get lyrics for songs | apiKey | True | unknown |
| [LastFm](https://www.last.fm/api) | Music | apiKey | True | unknown |
| [Lyrics.ovh](https://lyricsovh.docs.apiary.io) | Simple API to retrieve the lyrics of a song |  | True | unknown |
| [Mixcloud](https://www.mixcloud.com/developers/) | Music | OAuth | True | yes |
| [MusicBrainz](https://musicbrainz.org/doc/Development/XML_Web_Service/Version_2) | Music |  | True | unknown |
| [Musixmatch](https://developer.musixmatch.com/) | Music | apiKey | True | unknown |
| [Napster](https://developer.napster.com/api/v2.2) | Music | apiKey | True | yes |
| [Openwhyd](https://openwhyd.github.io/openwhyd/API) | Download curated playlists of streaming tracks (YouTube, SoundCloud, etc...) |  | True | no |
| [Phishin](https://phish.in/api-docs) | A web-based archive of legal live audio recordings of the improvisational rock band Phish | apiKey | True | no |
| [Radio Browser](https://api.radio-browser.info/) | List of internet radio stations |  | True | yes |
| [Songkick](https://www.songkick.com/developer/) | Music Events | apiKey | True | unknown |
| [Songlink / Odesli](https://www.notion.so/API-d0ebe08a5e304a55928405eb682f6741) | Get all the services on which a song is available | apiKey | True | yes |
| [Songsterr](https://www.songsterr.com/a/wa/api/) | Provides guitar, bass and drums tabs and chords |  | True | unknown |
| [SoundCloud](https://developers.soundcloud.com/docs/api/guide) | With SoundCloud API you can build applications that will give more power to control your content | OAuth | True | unknown |
| [Spotify](https://beta.developer.spotify.com/documentation/web-api/) | View Spotify music catalog, manage users' libraries, get recommendations and more | OAuth | True | unknown |
| [TasteDive](https://tastedive.com/read/api) | Similar artist API (also works for movies and TV shows) | apiKey | True | unknown |
| [TheAudioDB](https://www.theaudiodb.com/api_guide.php) | Music | apiKey | True | unknown |
| [Vagalume](https://api.vagalume.com.br/docs/) | Crowdsourced lyrics and music knowledge | apiKey | True | unknown |
...
| [Feedbin](https://github.com/feedbin/feedbin-api) | RSS reader | OAuth | True | unknown |
| [GNews](https://gnews.io/) | Search for news from various sources | apiKey | True | yes |
| [Graphs for Coronavirus](https://corona.dnsforfamily.com/api.txt) | Each Country separately and Worldwide Graphs for Coronavirus. Daily updates |  | True | yes |
| [Inshorts News](https://github.com/cyberboysumanjay/Inshorts-News-API) | Provides news from inshorts |  | True | unknown |
| [MarketAux](https://www.marketaux.com/) | Live stock market news with tagged tickers + sentiment and stats JSON API | apiKey | True | yes |
| [New York Times](https://developer.nytimes.com/) | The New York Times Developer Network | apiKey | True | unknown |
| [News](https://newsapi.org/) | Headlines currently published on a range of news sources and blogs | apiKey | True | unknown |
| [NewsData](https://newsdata.io/docs) | News data API for live-breaking news and headlines from reputed  news sources | apiKey | True | unknown |
| [NewsX](https://rapidapi.com/machaao-inc-machaao-inc-default/api/newsx/) | Get or Search Latest Breaking News with ML Powered Summaries 🤖 | apiKey | True | unknown |
| [NPR One](http://dev.npr.org/api/) | Personalized news listening experience from NPR | OAuth | True | unknown |
| [Spaceflight News](https://spaceflightnewsapi.net) | Spaceflight related news 🚀 |  | True | yes |
| [The Guardian](http://open-platform.theguardian.com/) | Access all the content the Guardian creates, categorised by tags and section | apiKey | True | unknown |
| [The Old Reader](https://github.com/theoldreader/api) | RSS reader | apiKey | True | unknown |
| [TheNews](https://www.thenewsapi.com/) | Aggregated headlines, top story and live news JSON API | apiKey | True | yes |
| [Trove](https://trove.nla.gov.au/about/create-something/using-api) | Search through the National Library of Australia collection of 1000s of digitised newspapers | apiKey | True | unknown |
...
| [BotsArchive](https://botsarchive.com/docs.html) | JSON formatted details about Telegram Bots available in database |  | True | unknown |
| [Callook.info](https://callook.info) | United States ham radio callsigns |  | True | unknown |
| [CARTO](https://carto.com/) | Location Information Prediction | apiKey | True | unknown |
| [CollegeScoreCard.ed.gov](https://collegescorecard.ed.gov/data/) | Data on higher education institutions in the United States |  | True | unknown |
| [Enigma Public](https://developers.enigma.com/docs) | Broadest collection of public data | apiKey | True | yes |
| [French Address Search](https://geo.api.gouv.fr/adresse) | Address search via the French Government |  | True | unknown |
| [GENESIS](https://www.destatis.de/EN/Service/OpenData/api-webservice.html) | Federal Statistical Office Germany | OAuth | True | unknown |
| [Joshua Project](https://api.joshuaproject.net/) | People groups of the world with the fewest followers of Christ | apiKey | True | unknown |
| [Kaggle](https://www.kaggle.com/docs/api) | Create and interact with Datasets, Notebooks, and connect with Kaggle | apiKey | True | unknown |
| [LinkPreview](https://www.linkpreview.net) | Get JSON formatted summary with title, description and preview image for any requested URL | apiKey | True | yes |
| [Lowy Asia Power Index](https://github.com/0x0is1/lowy-index-api-docs) | Get measure resources and influence to rank the relative power of states in Asia |  | True | unknown |
| [Microlink.io](https://microlink.io) | Extract structured data from any website |  | True | yes |
| [Nasdaq Data Link](https://docs.data.nasdaq.com/) | Stock market data | apiKey | True | unknown |
| [Nobel Prize](https://www.nobelprize.org/about/developer-zone-2/) | Open data about nobel prizes and events |  | True | yes |
| [Open Data Minneapolis](https://opendata.minneapolismn.gov/) | Spatial (GIS) and non-spatial city data for Minneapolis |  | True | no |
| [openAFRICA](https://africaopendata.org/) | Large datasets repository of African open data |  | True | unknown |
| [OpenCorporates](http://api.opencorporates.com/documentation/API-Reference) | Data on corporate entities and directors in many countries | apiKey | True | unknown |
| [OpenSanctions](https://www.opensanctions.org/docs/api/) | Data on international sanctions, crime and politically exposed persons |  | True | yes |
| [PeakMetrics](https://rapidapi.com/peakmetrics-peakmetrics-default/api/peakmetrics-news) | News articles and public datasets | apiKey | True | unknown |
| [Recreation Information Database](https://ridb.recreation.gov/) | Recreational areas, federal lands, historic sites, museums, and other attractions/resources(US) | apiKey | True | unknown |
| [Scoop.it](http://www.scoop.it/dev) | Content Curation Service | apiKey | False | unknown |
| [Socrata](https://dev.socrata.com/) | Access to Open Data from Governments, Non-profits and NGOs around the world | OAuth | True | yes |
| [Teleport](https://developers.teleport.org/) | Quality of Life Data |  | True | unknown |
| [Umeå Open Data](https://opendata.umea.se/api/) | Open data of the city Umeå in northen Sweden |  | True | yes |
| [Universities List](https://github.com/Hipo/university-domains-list) | University names, countries and domains |  | True | unknown |
| [University of Oslo](https://data.uio.no/) | Courses, lecture videos, detailed information for courses etc. for the University of Oslo (Norway) |  | True | unknown |
| [UPC database](https://upcdatabase.org/api) | More than 1.5 million barcode numbers from all around the world | apiKey | True | unknown |
| [Urban Observatory](https://urbanobservatory.ac.uk) | The largest set of publicly available real time urban data in the UK |  | False | no |
| [Wikidata](https://www.wikidata.org/w/api.php?action=help) | Collaboratively edited knowledge base operated by the Wikimedia Foundation | OAuth | True | unknown |
| [Wikipedia](https://www.mediawiki.org/wiki/API:Main_page) | Mediawiki Encyclopedia |  | True | unknown |
| [Yelp](https://www.yelp.com/developers/documentation/v3) | Find Local Business | OAuth | True | unknown |
...
| [Evil Insult Generator](https://evilinsult.com/api) | Evil Insults |  | True | yes |
| [GitHub Contribution Chart Generator](https://github-contributions.vercel.app) | Create an image of your GitHub contributions |  | True | yes |
| [GitHub ReadMe Stats](https://github.com/anuraghazra/github-readme-stats) | Add dynamically generated statistics to your GitHub profile ReadMe |  | True | yes |
| [Metabase](https://www.metabase.com/) | An open source Business Intelligence server to share data and analytics inside your company |  | True | yes |
| [Shields](https://shields.io/) | Concise, consistent, and legible badges in SVG and raster format |  | True | unknown |
...
| [FavQs.com](https://favqs.com/api) | FavQs allows you to collect, discover and share your favorite quotes | apiKey | True | unknown |
| [FOAAS](http://www.foaas.com/) | Fuck Off As A Service |  | False | unknown |
| [Forismatic](http://forismatic.com/en/api/) | Inspirational Quotes |  | False | unknown |
| [icanhazdadjoke](https://icanhazdadjoke.com/api) | The largest selection of dad jokes on the internet |  | True | unknown |
| [Inspiration](https://inspiration.goprogram.ai/docs/) | Motivational and Inspirational quotes |  | True | yes |
| [kanye.rest](https://kanye.rest) | REST API for random Kanye West quotes |  | True | yes |
| [kimiquotes](https://kimiquotes.herokuapp.com/doc) | Team radio and interview quotes by Finnish F1 legend Kimi Räikkönen |  | True | yes |
| [Medium](https://github.com/Medium/medium-api-docs) | Community of readers and writers offering unique perspectives on ideas | OAuth | True | unknown |
| [Programming Quotes](https://github.com/skolakoda/programming-quotes-api) | Programming Quotes API for open source projects |  | True | unknown |
| [Quotable Quotes](https://github.com/lukePeavey/quotable) | Quotable is a free, open source quotations API |  | True | unknown |
| [Quote Garden](https://pprathameshmore.github.io/QuoteGarden/) | REST API for more than 5000 famous quotes |  | True | unknown |
| [quoteclear](https://quoteclear.web.app/) | Ever-growing list of James Clear quotes from the 3-2-1 Newsletter |  | True | yes |
| [Quotes on Design](https://quotesondesign.com/api/) | Inspirational Quotes |  | True | unknown |
| [Stoicism Quote](https://github.com/tlcheah2/stoic-quote-lambda-public-api) | Quotes about Stoicism |  | True | unknown |
| [They Said So Quotes](https://theysaidso.com/api/) | Quotes Trusted by many fortune brands around the world |  | True | unknown |
| [Traitify](https://app.traitify.com/developer) | Assess, collect and analyze Personality |  | True | unknown |
| [Udemy(instructor)](https://www.udemy.com/developers/instructor/) | API for instructors on Udemy | apiKey | True | unknown |
| [Vadivelu HTTP Codes](https://vadivelu.anoram.com/) | On demand HTTP Codes with images |  | True | no |
| [Zen Quotes](https://zenquotes.io/) | Large collection of Zen quotes for inspiration |  | True | yes |
...
| [Veriphone](https://veriphone.io) | Phone number validation & carrier lookup | apiKey | True | yes |
...
| [Dagpi](https://dagpi.xyz) | Image manipulation and processing | apiKey | True | unknown |
| [Duply](https://duply.co/docs#getting-started-api) | Generate, Edit, Scale and Manage Images and Videos Smarter & Faster | apiKey | True | yes |
| [DynaPictures](https://dynapictures.com/docs/) | Generate Hundreds of Personalized Images in Minutes | apiKey | True | yes |
| [Flickr](https://www.flickr.com/services/api/) | Flickr Services | OAuth | True | unknown |
| [Getty Images](http://developers.gettyimages.com/en/) | Build applications using the world's most powerful imagery | OAuth | True | unknown |
| [Gfycat](https://developers.gfycat.com/api/) | Jiffier GIFs | OAuth | True | unknown |
| [Giphy](https://developers.giphy.com/docs/) | Get all your gifs | apiKey | True | unknown |
| [Google Photos](https://developers.google.com/photos) | Integrate Google Photos with your apps or devices | OAuth | True | unknown |
| [Imgur](https://apidocs.imgur.com/) | Images | OAuth | True | unknown |
| [Imsea](https://imsea.herokuapp.com/) | Free image search |  | True | unknown |
| [Lorem Picsum](https://picsum.photos/) | Images from Unsplash |  | True | unknown |
| [ObjectCut](https://objectcut.com/) | Image Background removal | apiKey | True | yes |
| [Pexels](https://www.pexels.com/api/) | Free Stock Photos and Videos | apiKey | True | yes |
| [PhotoRoom](https://www.photoroom.com/api/) | Remove background from images | apiKey | True | unknown |
| [Pixabay](https://pixabay.com/sk/service/about/api/) | Photography | apiKey | True | unknown |
| [PlaceKeanu](https://placekeanu.com/) | Resizable Keanu Reeves placeholder images with grayscale and young Keanu options |  | True | unknown |
| [Readme typing SVG](https://github.com/DenverCoder1/readme-typing-svg) | Customizable typing and deleting text SVG |  | True | unknown |
| [Remove.bg](https://www.remove.bg/api) | Image Background removal | apiKey | True | unknown |
| [ReSmush.it](https://resmush.it/api) | Photo optimization |  | False | unknown |
| [shutterstock](https://api-reference.shutterstock.com/) | Stock Photos and Videos | OAuth | True | unknown |
| [Sirv](https://apidocs.sirv.com/) | Image management solutions like optimization, manipulation, hosting | apiKey | True | unknown |
| [Unsplash](https://unsplash.com/developers) | Photography | OAuth | True | unknown |
| [Wallhaven](https://wallhaven.cc/help/api) | Wallpapers | apiKey | True | unknown |
| [Webdam](https://www.damsuccess.com/hc/en-us/articles/202134055-REST-API) | Images | OAuth | True | unknown |
...
| [iDigBio](https://github.com/idigbio/idigbio-search-api/wiki) | Access millions of museum specimens from organizations around the world |  | True | unknown |
| [inspirehep.net](https://github.com/inspirehep/rest-api-doc) | High Energy Physics info. system |  | True | unknown |
| [isEven (humor)](https://isevenapi.xyz/) | Check if a number is even |  | True | unknown |
| [ISRO](https://isro.vercel.app) | ISRO Space Crafts Information |  | True | no |
| [ITIS](https://www.itis.gov/ws_description.html) | Integrated Taxonomic Information System |  | True | unknown |
| [Launch Library 2](https://thespacedevs.com/llapi) | Spaceflight launches and events database |  | True | yes |
| [Materials Platform for Data Science](https://mpds.io) | Curated experimental data for materials science | apiKey | True | no |
| [Minor Planet Center](http://www.asterank.com/mpc) | Asterank.com Information |  | False | unknown |
| [NASA](https://api.nasa.gov) | NASA data, including imagery |  | True | no |
| [NASA ADS](https://ui.adsabs.harvard.edu/help/api/api-docs.html) | NASA Astrophysics Data System | OAuth | True | yes |
| [Newton](https://newton.vercel.app) | Symbolic and Arithmetic Math Calculator |  | True | no |
| [Noctua](https://api.noctuasky.com/api/v1/swaggerdoc/) | REST API used to access NoctuaSky features |  | True | unknown |
| [Numbers](https://math.tools/api/numbers/) | Number of the day, random number, number facts and anything else you want to do with numbers | apiKey | True | no |
| [Numbers](http://numbersapi.com) | Facts about numbers |  | False | no |
| [Ocean Facts](https://oceanfacts.herokuapp.com/) | Facts pertaining to the physical science of Oceanography |  | True | unknown |
| [Open Notify](http://open-notify.org/Open-Notify-API/) | ISS astronauts, current location, etc |  | False | no |
| [Open Science Framework](https://developer.osf.io) | Repository and archive for study designs, research materials, data, manuscripts, etc |  | True | unknown |
| [Purple Air](https://www2.purpleair.com/) | Real Time Air Quality Monitoring |  | True | unknown |
| [Remote Calc](https://github.com/elizabethadegbaju/remotecalc) | Decodes base64 encoding and parses it to return a solution to the calculation in JSON |  | True | yes |
| [SHARE](https://share.osf.io/api/v2/) | A free, open, dataset about research and scholarly activities |  | True | no |
| [SpaceX](https://github.com/r-spacex/SpaceX-API) | Company, vehicle, launchpad and launch data |  | True | no |
| [SpaceX](https://api.spacex.land/graphql/) | GraphQL, Company, Ships, launchpad and launch data |  | True | unknown |
| [Sunrise and Sunset](https://sunrise-sunset.org/api) | Sunset and sunrise times for a given latitude and longitude |  | True | no |
| [Times Adder](https://github.com/FranP-code/API-Times-Adder) | With this API you can add each of the times introduced in the array sended |  | True | no |
| [TLE](https://tle.ivanstanojevic.me/#/docs) | Satellite information |  | True | no |
| [USGS Earthquake Hazards Program](https://earthquake.usgs.gov/fdsnws/event/1/) | Earthquakes data real-time |  | True | no |
| [USGS Water Services](https://waterservices.usgs.gov/) | Water quality and level info for rivers and lakes |  | True | no |
| [World Bank](https://datahelpdesk.worldbank.org/knowledgebase/topics/125589) | World Data |  | True | no |
| [xMath](https://x-math.herokuapp.com/) | Random mathematical expressions |  | True | yes |
...
| [Bugcrowd](https://docs.bugcrowd.com/api/getting-started/) | Bugcrowd API for interacting and tracking the reported issues programmatically | apiKey | True | unknown |
| [Censys](https://search.censys.io/api) | Search engine for Internet connected host and devices | apiKey | True | no |
...
| [FingerprintJS Pro](https://dev.fingerprintjs.com/docs) | Fraud detection API offering highly accurate browser fingerprinting | apiKey | True | yes |
| [FraudLabs Pro](https://www.fraudlabspro.com/developer/api/screen-order) | Screen order information using AI to detect frauds | apiKey | True | unknown |
| [FullHunt](https://api-docs.fullhunt.io/#introduction) | Searchable attack surface database of the entire internet | apiKey | True | unknown |
| [GitGuardian](https://api.gitguardian.com/doc) | Scan files for secrets (API Keys, database credentials) | apiKey | True | no |
| [GreyNoise](https://docs.greynoise.io/reference/get_v3-community-ip) | Query IPs in the GreyNoise dataset and retrieve a subset of the full IP context data | apiKey | True | unknown |
| [HackerOne](https://api.hackerone.com/) | The industry’s first hacker API that helps increase productivity towards creative bug bounty hunting | apiKey | True | unknown |
| [Hashable](https://hashable.space/pages/api/) | A REST API to access high level cryptographic functions and methods |  | True | yes |
| [HaveIBeenPwned](https://haveibeenpwned.com/API/v3) | Passwords which have previously been exposed in data breaches | apiKey | True | unknown |
| [Intelligence X](https://github.com/IntelligenceX/SDK/blob/master/Intelligence%20X%20API.pdf) | Perform OSINT via Intelligence X | apiKey | True | unknown |
| [LoginRadius](https://www.loginradius.com/docs/) | Managed User Authentication Service | apiKey | True | yes |
| [Microsoft Security Response Center (MSRC)](https://msrc.microsoft.com/report/developer) | Programmatic interfaces to engage with the Microsoft Security Response Center (MSRC) |  | True | unknown |
| [Mozilla http scanner](https://github.com/mozilla/http-observatory/blob/master/httpobs/docs/api.md) | Mozilla observatory http scanner |  | True | unknown |
| [Mozilla tls scanner](https://github.com/mozilla/tls-observatory#api-endpoints) | Mozilla observatory tls scanner |  | True | unknown |
| [National Vulnerability Database](https://nvd.nist.gov/vuln/Data-Feeds/JSON-feed-changelog) | U.S. National Vulnerability Database |  | True | unknown |
| [Passwordinator](https://github.com/fawazsullia/password-generator/) | Generate random passwords of varying complexities |  | True | yes |
| [PhishStats](https://phishstats.info/) | Phishing database |  | True | unknown |
| [Privacy.com](https://privacy.com/developer/docs) | Generate merchant-specific and one-time use credit card numbers that link back to your bank | apiKey | True | unknown |
| [Pulsedive](https://pulsedive.com/api/) | Scan, search and collect threat intelligence data in real-time | apiKey | True | unknown |
| [SecurityTrails](https://securitytrails.com/corp/apidocs) | Domain and IP related information such as current and historical WHOIS and DNS records | apiKey | True | unknown |
| [Shodan](https://developer.shodan.io/) | Search engine for Internet connected devices | apiKey | True | unknown |
| [Spyse](https://spyse-dev.readme.io/reference/quick-start) | Access data on all Internet assets and build powerful attack surface management applications | apiKey | True | unknown |
| [Threat Jammer](https://threatjammer.com/docs/index) | Risk scoring service from curated threat intelligence data | apiKey | True | unknown |
| [UK Police](https://data.police.uk/docs/) | UK Police data |  | True | unknown |
| [Virushee](https://api.virushee.com/) | Virushee file/data scanning |  | True | yes |
| [VulDB](https://vuldb.com/?doc.api) | VulDB API allows to initiate queries for one or more items along with transactional bots | apiKey | True | unknown |
...
| [Etsy](https://www.etsy.com/developers/documentation/getting_started/api_basics) | Manage shop and interact with listings | OAuth | True | unknown |
| [Flipkart Marketplace](https://seller.flipkart.com/api-docs/FMSAPI.html) | Product listing management, Order Fulfilment in the Flipkart Marketplace | OAuth | True | yes |
| [Lazada](https://open.lazada.com/doc/doc.htm) | Retrieve product ratings and seller performance metrics | apiKey | True | unknown |
| [Mercadolibre](https://developers.mercadolibre.cl/es_ar/api-docs-es) | Manage sales, ads, products, services and Shops | apiKey | True | unknown |
| [Octopart](https://octopart.com/api/v4/reference) | Electronic part data for manufacturing, design, and sourcing | apiKey | True | unknown |
| [OLX Poland](https://developer.olx.pl/api/doc#section/) | Integrate with local sites by posting, managing adverts and communicating with OLX users | apiKey | True | unknown |
| [Rappi](https://dev-portal.rappi.com/) | Manage orders from Rappi's app | OAuth | True | unknown |
| [Shopee](https://open.shopee.com/documents?version=1) | Shopee's official API for integration of various services from Shopee | apiKey | True | unknown |
| [Tokopedia](https://developer.tokopedia.com/openapi/guide/#/) | Tokopedia's Official API for integration of various services from Tokopedia | OAuth | True | unknown |
| [WooCommerce](https://woocommerce.github.io/woocommerce-rest-api-docs/) | WooCommerce REST APIS to create, read, update, and delete data on wordpress website in JSON format | apiKey | True | yes |
...
| [Cisco Spark](https://developer.ciscospark.com) | Team Collaboration Software | OAuth | True | unknown |
| [Dangerous Discord Database](https://discord.riverside.rocks/docs/index.php) | Database of malicious Discord accounts | apiKey | True | unknown |
| [Discord](https://discord.com/developers/docs/intro) | Make bots for Discord, integrate Discord onto an external platform | OAuth | True | unknown |
| [Disqus](https://disqus.com/api/docs/auth/) | Communicate with Disqus data | OAuth | True | unknown |
| [Doge-Meme](https://api.doge-meme.lol/docs) | Top meme posts from r/dogecoin which include 'Meme' flair |  | True | yes |
| [Facebook](https://developers.facebook.com/) | Facebook Login, Share on FB, Social Plugins, Analytics and more | OAuth | True | unknown |
| [Foursquare](https://developer.foursquare.com/) | Interact with Foursquare users and places (geolocation-based checkins, photos, tips, events, etc) | OAuth | True | unknown |
| [Fuck Off as a Service](https://www.foaas.com) | Asks someone to fuck off |  | True | unknown |
| [Full Contact](https://docs.fullcontact.com/) | Get Social Media profiles and contact Information | OAuth | True | unknown |
| [HackerNews](https://github.com/HackerNews/API) | Social news for CS and entrepreneurship |  | True | unknown |
| [Hashnode](https://hashnode.com) | A blogging platform built for developers |  | True | unknown |
| [Instagram](https://www.instagram.com/developer/) | Instagram Login, Share on Instagram, Social Plugins and more | OAuth | True | unknown |
| [Kakao](https://developers.kakao.com/) | Kakao Login, Share on KakaoTalk, Social Plugins and more | OAuth | True | unknown |
| [Lanyard](https://github.com/Phineas/lanyard) | Retrieve your presence on Discord through an HTTP REST API or WebSocket |  | True | yes |
| [Line](https://developers.line.biz/) | Line Login, Share on Line, Social Plugins and more | OAuth | True | unknown |
| [LinkedIn](https://docs.microsoft.com/en-us/linkedin/?context=linkedin/context) | The foundation of all digital integrations with LinkedIn | OAuth | True | unknown |
| [Meetup.com](https://www.meetup.com/api/guide) | Data about Meetups from Meetup.com | apiKey | True | unknown |
| [Microsoft Graph](https://docs.microsoft.com/en-us/graph/api/overview) | Access the data and intelligence in Microsoft 365, Windows 10, and Enterprise Mobility | OAuth | True | unknown |
| [NAVER](https://developers.naver.com/main/) | NAVER Login, Share on NAVER, Social Plugins and more | OAuth | True | unknown |
| [Open Collective](https://docs.opencollective.com/help/developers/api) | Get Open Collective data |  | True | unknown |
| [Pinterest](https://developers.pinterest.com/) | The world's catalog of ideas | OAuth | True | unknown |
| [Product Hunt](https://api.producthunt.com/v2/docs) | The best new products in tech | OAuth | True | unknown |
| [Reddit](https://www.reddit.com/dev/api) | Homepage of the internet | OAuth | True | unknown |
| [Revolt](https://developers.revolt.chat/api/) | Revolt open source Discord alternative | apiKey | True | unknown |
| [Saidit](https://www.saidit.net/dev/api) | Open Source Reddit Clone | OAuth | True | unknown |
| [Slack](https://api.slack.com/) | Team Instant Messaging | OAuth | True | unknown |
| [TamTam](https://dev.tamtam.chat/) | Bot API to interact with TamTam | apiKey | True | unknown |
| [Telegram Bot](https://core.telegram.org/bots/api) | Simplified HTTP version of the MTProto API for bots | apiKey | True | unknown |
| [Telegram MTProto](https://core.telegram.org/api#getting-started) | Read and write Telegram data | OAuth | True | unknown |
| [Telegraph](https://telegra.ph/api) | Create attractive blogs easily, to share | apiKey | True | unknown |
| [TikTok](https://developers.tiktok.com/doc/login-kit-web) | Fetches user info and user's video posts on TikTok platform | OAuth | True | unknown |
| [Trash Nothing](https://trashnothing.com/developer) | A freecycling community with thousands of free items posted every day | OAuth | True | yes |
...
| [City Bikes](https://api.citybik.es/v2/) | City Bikes around the world |  | True | unknown |
| [Cloudbet](https://www.cloudbet.com/api/) | Official Cloudbet API provides real-time sports odds and betting API to place bets programmatically | apiKey | True | yes |
| [CollegeFootballData.com](https://collegefootballdata.com) | Unofficial detailed American college football statistics, records, and results API | apiKey | True | unknown |
| [Ergast F1](http://ergast.com/mrd/) | F1 data from the beginning of the world championships in 1950 |  | True | unknown |
| [Fitbit](https://dev.fitbit.com/) | Fitbit Information | OAuth | True | unknown |
| [Football](https://rapidapi.com/GiulianoCrescimbeni/api/football98/) | A simple Open Source Football API to get squads’ stats, best scorers and more | X-Mashape-Key | True | unknown |
| [Football (Soccer) Videos](https://www.scorebat.com/video-api/) | Embed codes for goals and highlights from Premier League, Bundesliga, Serie A and many more |  | True | yes |
| [Football Standings](https://github.com/azharimm/football-standings-api) | Display football standings e.g epl, la liga, serie a etc. The data is based on espn site |  | True | yes |
| [Football-Data](https://www.football-data.org) | Football data with matches info, players, teams, and competitions | X-Mashape-Key | True | unknown |
| [JCDecaux Bike](https://developer.jcdecaux.com/) | JCDecaux's self-service bicycles | apiKey | True | unknown |
| [MLB Records and Stats](https://appac.github.io/mlb-data-api-docs/) | Current and historical MLB statistics |  | False | unknown |
| [NBA Data](https://rapidapi.com/api-sports/api/api-nba/) | All NBA Stats DATA, Games, Livescore, Standings, Statistics | apiKey | True | unknown |
| [NBA Stats](https://any-api.com/nba_com/nba_com/docs/API_Description) | Current and historical NBA Statistics |  | True | unknown |
| [NHL Records and Stats](https://gitlab.com/dword4/nhlapi) | NHL historical data and statistics |  | True | unknown |
| [Oddsmagnet](https://data.oddsmagnet.com) | Odds history from multiple UK bookmakers |  | True | yes |
| [OpenLigaDB](https://www.openligadb.de) | Crowd sourced sports league results |  | True | yes |
| [Premier League Standings ](https://rapidapi.com/heisenbug/api/premier-league-live-scores/) | All Current Premier League Standings and Statistics | apiKey | True | unknown |
| [Sport Data](https://sportdataapi.com) | Get sports data from all over the world | apiKey | True | unknown |
| [Sport List & Data](https://developers.decathlon.com/products/sports) | List of and resources related to sports |  | True | yes |
| [Sport Places](https://developers.decathlon.com/products/sport-places) | Crowd-source sports places around the world |  | True | no |
| [Sport Vision](https://developers.decathlon.com/products/sport-vision) | Identify sport, brands and gear in an image. Also does image sports captioning | apiKey | True | yes |
| [Sportmonks Cricket](https://docs.sportmonks.com/cricket/) | Live cricket score, player statistics and fantasy API | apiKey | True | unknown |
...
| [Wger](https://wger.de/en/software/api) | Workout manager data as exercises, muscles or equipment | apiKey | True | unknown |
...
| [FakerAPI](https://fakerapi.it/en) | APIs collection to get fake data |  | True | yes |
| [FakeStoreAPI](https://fakestoreapi.com/) | Fake store rest API for your e-commerce or shopping website prototype |  | True | unknown |
| [GeneradorDNI](https://api.generadordni.es) | Data generator API. Profiles, vehicles, banks and cards, etc | apiKey | True | unknown |
| [ItsThisForThat](https://itsthisforthat.com/api.php) | Generate Random startup ideas |  | True | no |
| [JSONPlaceholder](http://jsonplaceholder.typicode.com/) | Fake data for testing and prototyping |  | False | unknown |
| [Loripsum](http://loripsum.net/) | The "lorem ipsum" generator that doesn't suck |  | False | unknown |
| [Mailsac](https://mailsac.com/docs/api) | Disposable Email | apiKey | True | unknown |
| [Metaphorsum](http://metaphorpsum.com/) | Generate demo paragraphs giving number of words and sentences |  | False | unknown |
| [Mockaroo](https://www.mockaroo.com/docs) | Generate fake data to JSON, CSV, TXT, SQL and XML | apiKey | True | unknown |
| [QuickMocker](https://quickmocker.com) | API mocking tool to generate contextual, fake or random data |  | True | yes |
| [Random Data](https://random-data-api.com) | Random data generator |  | True | unknown |
...
| [Toolcarton](https://testimonialapi.toolcarton.com/) | Generate random testimonial data |  | True | unknown |
| [UUID Generator](https://www.uuidtools.com/docs) | Generate UUIDs |  | True | no |
| [What The Commit](http://whatthecommit.com/index.txt) | Random commit message generator |  | False | yes |
| [Yes No](https://yesno.wtf/api) | Generate yes or no randomly |  | True | unknown |
...
| [Detect Language](https://detectlanguage.com/) | Detects text language | apiKey | True | unknown |
| [ELI](https://nlp.insightera.co.th/docs/v1.0) | Natural Language Processing Tools for Thai Language | apiKey | True | unknown |
| [Google Cloud Natural](https://cloud.google.com/natural-language/docs/) | Natural language understanding technology, including sentiment, entity and syntax analysis | apiKey | True | unknown |
| [Hirak OCR](https://ocr.hirak.site/) | Image to text -text recognition- from image more than 100 language, accurate, unlimited requests | apiKey | True | unknown |
| [Hirak Translation](https://translate.hirak.site/) | Translate between 21 of most used languages, accurate, unlimited requests | apiKey | True | unknown |
| [Lecto Translation](https://rapidapi.com/lecto-lecto-default/api/lecto-translation/) | Translation API with free tier and reasonable prices | apiKey | True | yes |
| [LibreTranslate](https://libretranslate.com/docs) | Translation tool with 17 available languages |  | True | unknown |
| [Semantria](https://semantria.readme.io/docs) | Text Analytics with sentiment analysis, categorization & named entity extraction | OAuth | True | unknown |
| [Sentiment Analysis](https://www.meaningcloud.com/developer/sentiment-analysis) | Multilingual sentiment analysis of texts from different sources | apiKey | True | yes |
| [Tisane](https://tisane.ai/) | Text Analytics with focus on detection of abusive content and law enforcement applications | OAuth | True | yes |
| [Watson Natural Language Understanding](https://cloud.ibm.com/apidocs/natural-language-understanding/natural-language-understanding) | Natural language processing for advanced text analysis | OAuth | True | unknown |
...
| [Postmon](http://postmon.com.br) | An API to query Brazilian ZIP codes and orders easily, quickly and free |  | False | unknown |
| [PostNord](https://developer.postnord.com/api) | Provides information about parcels in transport for Sweden and Denmark | apiKey | False | unknown |
| [UPS](https://www.ups.com/upsdeveloperkit) | Shipment and Address information | apiKey | True | unknown |
| [WeCanTrack](https://docs.wecantrack.com) | Automatically place subids in affiliate links to attribute affiliate conversions to click data | apiKey | True | yes |
| [WhatPulse](https://developer.whatpulse.org/#web-api) | Small application that measures your keyboard/mouse usage |  | True | unknown |
...
| [apilayer aviationstack](https://aviationstack.com/) | Real-time Flight Status & Global Aviation Data API | OAuth | True | unknown |
| [AviationAPI](https://docs.aviationapi.com) | FAA Aeronautical Charts and Publications, Airport Information, and Airport Weather |  | True | no |
| [AZ511](https://www.az511.com/developers/doc) | Access traffic data from the ADOT API | apiKey | True | unknown |
| [Bay Area Rapid Transit](http://api.bart.gov) | Stations and predicted arrivals for BART | apiKey | False | unknown |
| [BC Ferries](https://www.bcferriesapi.ca) | Sailing times and capacities for BC Ferries |  | True | yes |
| [BIC-Boxtech](https://docs.bic-boxtech.org/) | Container technical detail for the global container fleet | OAuth | True | unknown |
| [BlaBlaCar](https://dev.blablacar.com) | Search car sharing trips | apiKey | True | unknown |
| [Boston MBTA Transit](https://www.mbta.com/developers/v3-api) | Stations and predicted arrivals for MBTA | apiKey | True | unknown |
| [Community Transit](https://github.com/transitland/transitland-datastore/blob/master/README.md#api-endpoints) | Transitland API |  | True | unknown |
| [Compare Flight Prices](https://rapidapi.com/obryan-software-obryan-software-default/api/compare-flight-prices/) | API for comparing flight prices across platforms | apiKey | True | unknown |
| [CTS](https://api.cts-strasbourg.eu/) | CTS Realtime API | apiKey | True | yes |
| [Grab](https://developer.grab.com/docs/) | Track deliveries, ride fares, payments and loyalty points | OAuth | True | unknown |
| [GraphHopper](https://docs.graphhopper.com/) | A-to-B routing with turn-by-turn instructions | apiKey | True | unknown |
| [Icelandic APIs](http://docs.apis.is/) | Open APIs that deliver services in or regarding Iceland |  | True | unknown |
| [Impala Hotel Bookings](https://docs.impala.travel/docs/booking-api/) | Hotel content, rates and room bookings | apiKey | True | no |
| [Izi](http://api-docs.izi.travel/) | Audio guide for travellers | apiKey | True | unknown |
| [Land Transport Authority DataMall, Singapore](https://datamall.lta.gov.sg/content/dam/datamall/datasets/LTA_DataMall_API_User_Guide.pdf) | Singapore transport information | apiKey | False | unknown |
| [Metro Lisboa](http://app.metrolisboa.pt/status/getLinhas.php) | Delays in subway lines |  | False | no |
| [Navitia](https://doc.navitia.io/) | The open API for building cool stuff with transport data | apiKey | True | unknown |
| [Open Charge Map](https://openchargemap.org/site/develop/api) | Global public registry of electric vehicle charging locations | apiKey | True | yes |
| [OpenSky Network](https://opensky-network.org/apidoc/index.html) | Free real-time ADS-B aviation data |  | True | unknown |
| [Railway Transport for France](https://www.digital.sncf.com/startup/api) | SNCF public API | apiKey | True | unknown |
| [REFUGE Restrooms](https://www.refugerestrooms.org/api/docs/#!/restrooms) | Provides safe restroom access for transgender, intersex and gender nonconforming individuals |  | True | unknown |
| [Sabre for Developers](https://developer.sabre.com/guides/travel-agency/quickstart/getting-started-in-travel) | Travel Search - Limited usage | apiKey | True | unknown |
| [Schiphol Airport](https://developer.schiphol.nl/) | Schiphol | apiKey | True | unknown |
| [Tankerkoenig](https://creativecommons.tankerkoenig.de/swagger/) | German realtime gas/diesel prices | apiKey | True | yes |
| [TransitLand](https://www.transit.land/documentation/datastore/api-endpoints.html) | Transit Aggregation |  | True | unknown |
| [Transport for Atlanta, US](http://www.itsmarta.com/app-developer-resources.aspx) | Marta |  | False | unknown |
| [Transport for Auckland, New Zealand](https://dev-portal.at.govt.nz/) | Auckland Transport |  | True | unknown |
| [Transport for Belgium](https://docs.irail.be/) | The iRail API is a third-party API for Belgian public transport by train |  | True | yes |
| [Transport for Berlin, Germany](https://github.com/derhuerst/vbb-rest/blob/3/docs/index.md) | Third-party VBB API |  | True | unknown |
| [Transport for Bordeaux, France](https://opendata.bordeaux-metropole.fr/explore/) | Bordeaux Métropole public transport and more (France) | apiKey | True | unknown |
| [Transport for Budapest, Hungary](https://bkkfutar.docs.apiary.io) | Budapest public transport API |  | True | unknown |
| [Transport for Chicago, US](http://www.transitchicago.com/developers/) | Chicago Transit Authority (CTA) | apiKey | False | unknown |
| [Transport for Czech Republic](https://www.chaps.cz/eng/products/idos-internet) | Czech transport API |  | True | unknown |
| [Transport for Denver, US](http://www.rtd-denver.com/gtfs-developer-guide.shtml) | RTD |  | False | unknown |
| [Transport for Finland](https://digitransit.fi/en/developers/ ) | Finnish transport API |  | True | unknown |
| [Transport for Germany](http://data.deutschebahn.com/dataset/api-fahrplan) | Deutsche Bahn (DB) API | apiKey | False | unknown |
| [Transport for Grenoble, France](https://www.mobilites-m.fr/pages/opendata/OpenDataApi.html) | Grenoble public transport |  | False | no |
| [Transport for Hessen, Germany](https://opendata.rmv.de/site/start.html) | RMV API (Public Transport in Hessen) |  | True | unknown |
| [Transport for Honolulu, US](http://hea.thebus.org/api_info.asp) | Honolulu Transportation Information | apiKey | False | unknown |
| [Transport for Lisbon, Portugal](https://emel.city-platform.com/opendata/) | Data about buses routes, parking and traffic | apiKey | True | unknown |
| [Transport for London, England](https://api.tfl.gov.uk) | TfL API | apiKey | True | unknown |
| [Transport for Los Angeles, US](https://developer.metro.net/api/) | Data about positions of Metro vehicles in real time and travel their routes |  | True | unknown |
| [Transport for Manchester, England](https://developer.tfgm.com/) | TfGM transport network data | apiKey | True | no |
| [Transport for Norway](https://developer.entur.org/) | Transport APIs and dataset for Norway |  | True | unknown |
| [Transport for Ottawa, Canada](https://www.octranspo.com/en/plan-your-trip/travel-tools/developers) | OC Transpo API | apiKey | True | unknown |
| [Transport for Paris, France](http://data.ratp.fr/api/v1/console/datasets/1.0/search/) | RATP Open Data API |  | False | unknown |
| [Transport for Philadelphia, US](http://www3.septa.org/hackathon/) | SEPTA APIs |  | False | unknown |
| [Transport for Sao Paulo, Brazil](http://www.sptrans.com.br/desenvolvedores/api-do-olho-vivo-guia-de-referencia/documentacao-api/) | SPTrans | OAuth | False | unknown |
| [Transport for Spain](https://data.renfe.com/api/1/util/snippet/api_info.html?resource_id=a2368cff-1562-4dde-8466-9635ea3a572a) | Public trains of Spain |  | True | unknown |
| [Transport for Sweden](https://www.trafiklab.se/api) | Public Transport consumer | OAuth | True | unknown |
| [Transport for Switzerland](https://opentransportdata.swiss/en/) | Official Swiss Public Transport Open Data | apiKey | True | unknown |
| [Transport for Switzerland](https://transport.opendata.ch/) | Swiss public transport API |  | True | unknown |
| [Transport for The Netherlands](http://www.ns.nl/reisinformatie/ns-api) | NS, only trains | apiKey | False | unknown |
| [Transport for The Netherlands](https://github.com/skywave/KV78Turbo-OVAPI/wiki) | OVAPI, country-wide public transport |  | True | unknown |
| [Transport for Toronto, Canada](https://myttc.ca/developers) | TTC |  | True | unknown |
| [Transport for UK](https://developer.transportapi.com) | Transport API and dataset for UK | apiKey | True | unknown |
| [Transport for United States](https://retro.umoiq.com/xmlFeedDocs/NextBusXMLFeed.pdf) | NextBus API |  | False | unknown |
| [Transport for Vancouver, Canada](https://developer.translink.ca/) | TransLink | OAuth | True | unknown |
| [Transport for Washington, US](https://developer.wmata.com/) | Washington Metro transport API | OAuth | True | unknown |
| [transport.rest](https://transport.rest) | Community maintained, developer-friendly public transport API |  | True | yes |
| [Tripadvisor](https://developer-tripadvisor.com/home/) | Rating content for a hotel, restaurant, attraction or destination | apiKey | True | unknown |
| [Uber](https://developer.uber.com/products) | Uber ride requests and price estimation | OAuth | True | yes |
| [Velib metropolis, Paris, France](https://www.velib-metropole.fr/donnees-open-data-gbfs-du-service-velib-metropole) | Velib Open Data API |  | True | no |
...
| [Clico](https://cli.com/swagger-ui/index.html?configUrl=/v3/api-docs/swagger-config) | URL shortener service | apiKey | True | unknown |
| [Cutt.ly](https://cutt.ly/api-documentation/cuttly-links-api) | URL shortener service | apiKey | True | unknown |
| [Drivet URL Shortener](https://wiki.drivet.xyz/en/url-shortener/add-links) | Shorten a long URL easily and fast |  | True | unknown |
| [Free Url Shortener](https://ulvis.net/developer.html) | Free URL Shortener offers a powerful API to interact with other sites |  | True | unknown |
| [Git.io](https://github.blog/2011-11-10-git-io-github-url-shortener/) | Git.io URL shortener |  | True | unknown |
| [GoTiny](https://github.com/robvanbakel/gotiny-api) | A lightweight URL shortener, focused on ease-of-use for the developer and end-user |  | True | yes |
| [Kutt](https://docs.kutt.it/) | Free Modern URL Shortener | apiKey | True | yes |
| [Mgnet.me](http://mgnet.me/api.html) | Torrent URL shorten API |  | True | no |
| [owo](https://owo.vc/api) | A simple link obfuscator/shortener |  | True | unknown |
| [Rebrandly](https://developers.rebrandly.com/v1/docs) | Custom URL shortener for sharing branded links | apiKey | True | unknown |
| [Short Link](https://github.com/FayasNoushad/Short-Link-API) | Short URLs support so many domains |  | True | unknown |
| [Shrtcode](https://shrtco.de/docs) | URl Shortener with multiple Domains |  | True | yes |
| [Shrtlnk](https://shrtlnk.dev/developer) | Simple and efficient short link creation | apiKey | True | yes |
| [TinyURL](https://tinyurl.com/app/dev) | Shorten long URLs | apiKey | True | no |
| [UrlBae](https://urlbae.com/developers) | Simple and efficient short link creation | apiKey | True | yes |
...
| [NHTSA](https://vpic.nhtsa.dot.gov/api/) | NHTSA Product Information Catalog and Vehicle Listing |  | True | unknown |
| [Smartcar](https://smartcar.com/docs/) | Lock and unlock vehicles and get data like odometer reading and location. Works on most new cars | OAuth | True | yes |
...
| [Catalogopolis](https://api.catalogopolis.xyz/docs/) | Doctor Who API |  | True | unknown |
| [Catch The Show](https://catchtheshow.herokuapp.com/api/documentation) | REST API for next-episode.net |  | True | unknown |
| [Czech Television](http://www.ceskatelevize.cz/xml/tv-program/) | TV programme of Czech TV |  | False | unknown |
| [Dailymotion](https://developer.dailymotion.com/) | Dailymotion Developer API | OAuth | True | unknown |
| [Dune](https://github.com/ywalia01/dune-api) | A simple API which provides you with book, character, movie and quotes JSON data |  | True | yes |
| [Final Space](https://finalspaceapi.com/docs/) | Final Space API |  | True | yes |
| [Game of Thrones Quotes](https://gameofthronesquotes.xyz/) | Some Game of Thrones quotes |  | True | unknown |
| [Harry Potter Charactes](https://hp-api.herokuapp.com/) | Harry Potter Characters Data with with imagery |  | True | unknown |
| [IMDb-API](https://imdb-api.com/) | API for receiving movie, serial and cast information | apiKey | True | unknown |
| [IMDbOT](https://github.com/SpEcHiDe/IMDbOT) | Unofficial IMDb Movie / Series Information |  | True | yes |
| [JSON2Video](https://json2video.com) | Create and edit videos programmatically: watermarks,resizing,slideshows,voice-over,text animations | apiKey | True | no |
| [Lucifer Quotes](https://github.com/shadowoff09/lucifer-quotes) | Returns Lucifer quotes |  | True | unknown |
| [MCU Countdown](https://github.com/DiljotSG/MCU-Countdown) | A Countdown to the next MCU Film |  | True | yes |
| [Motivational Quotes](https://nodejs-quoteapp.herokuapp.com/) | Random Motivational Quotes |  | True | unknown |
| [Movie Quote](https://github.com/F4R4N/movie-quote/) | Random Movie and Series Quotes |  | True | yes |
| [Open Movie Database](http://www.omdbapi.com/) | Movie information | apiKey | True | unknown |
| [Owen Wilson Wow](https://owen-wilson-wow-api.herokuapp.com) | API for actor Owen Wilson's "wow" exclamations in movies |  | True | yes |
| [Ron Swanson Quotes](https://github.com/jamesseanwright/ron-swanson-quotes#ron-swanson-quotes-api) | Television |  | True | unknown |
| [Simkl](https://simkl.docs.apiary.io) | Movie, TV and Anime data | apiKey | True | unknown |
| [STAPI](http://stapi.co) | Information on all things Star Trek |  | False | no |
| [Stranger Things Quotes](https://github.com/shadowoff09/strangerthings-quotes) | Returns Stranger Things quotes |  | True | unknown |
| [Stream](https://api.stream.cz/graphiql) | Czech internet television, films, series and online videos for free |  | True | no |
| [Stromberg Quotes](https://www.stromberg-api.de/) | Returns Stromberg quotes and more |  | True | unknown |
| [SWAPI](https://swapi.dev/) | All the Star Wars data you've ever wanted |  | True | yes |
| [SWAPI](https://www.swapi.tech) | All things Star Wars |  | True | yes |
| [SWAPI GraphQL](https://graphql.org/swapi-graphql) | Star Wars GraphQL API |  | True | unknown |
| [The Lord of the Rings](https://the-one-api.dev/) | The Lord of the Rings API | apiKey | True | unknown |
| [The Vampire Diaries](https://vampire-diaries-api.netlify.app/) | TV Show Data | apiKey | True | yes |
| [ThronesApi](https://thronesapi.com/) | Game Of Thrones Characters Data with imagery |  | True | unknown |
| [TMDb](https://www.themoviedb.org/documentation/api) | Community-based movie data | apiKey | True | unknown |
| [TrailerAddict](https://www.traileraddict.com/trailerapi) | Easily embed trailers from TrailerAddict | apiKey | False | unknown |
| [Trakt](https://trakt.docs.apiary.io/) | Movie and TV Data | apiKey | True | yes |
| [TVDB](https://thetvdb.com/api-information) | Television data | apiKey | True | unknown |
| [TVMaze](http://www.tvmaze.com/api) | TV Show Data |  | False | unknown |
| [uNoGS](https://rapidapi.com/unogs/api/unogsng) | Unofficial Netflix Online Global Search, Search all netflix regions in one place | apiKey | True | yes |
| [Vimeo](https://developer.vimeo.com/) | Vimeo Developer API | OAuth | True | unknown |
| [Watchmode](https://api.watchmode.com/) | API for finding out the streaming availability of movies & shows | apiKey | True | unknown |
| [Web Series Quotes Generator](https://github.com/yogeshwaran01/web-series-quotes) | API generates various Web Series Quote Images |  | True | yes |
| [YouTube](https://developers.google.com/youtube/) | Add YouTube functionality to your sites and apps | OAuth | True | unknown |
...
| [APIXU](https://www.apixu.com/doc/request.aspx) | Weather | apiKey | True | unknown |
| [AQICN](https://aqicn.org/api/) | Air Quality Index Data for over 1000 cities | apiKey | True | unknown |
| [AviationWeather](https://www.aviationweather.gov/dataserver) | NOAA aviation weather forecasts and observations |  | True | unknown |
| [ColorfulClouds](https://open.caiyunapp.com/ColorfulClouds_Weather_API) | Weather | apiKey | True | yes |
| [Euskalmet](https://opendata.euskadi.eus/api-euskalmet/-/api-de-euskalmet/) | Meteorological data of the Basque Country | apiKey | True | unknown |
| [Foreca](https://developer.foreca.com) | Weather | OAuth | True | unknown |
| [HG Weather](https://hgbrasil.com/status/weather) | Provides weather forecast data for cities in Brazil | apiKey | True | yes |
| [Hong Kong Obervatory](https://www.hko.gov.hk/en/abouthko/opendata_intro.htm) | Provide weather information, earthquake information, and climate data |  | True | unknown |
| [MetaWeather](https://www.metaweather.com/api/) | Weather |  | True | no |
| [Meteorologisk Institutt](https://api.met.no/weatherapi/documentation) | Weather and climate data | User-Agent | True | unknown |
| [Micro Weather](https://m3o.com/weather/api) | Real time weather forecasts and historic data | apiKey | True | unknown |
| [ODWeather](http://api.oceandrivers.com/static/docs.html) | Weather and weather webcams |  | False | unknown |
| [Oikolab](https://docs.oikolab.com) | 70+ years of global, hourly historical and forecast weather data from NOAA and ECMWF | apiKey | True | yes |
| [Open-Meteo](https://open-meteo.com/) | Global weather forecast API for non-commercial use |  | True | yes |
| [openSenseMap](https://api.opensensemap.org/) | Data from Personal Weather Stations called senseBoxes |  | True | yes |
| [OpenUV](https://www.openuv.io) | Real-time UV Index Forecast | apiKey | True | unknown |
| [OpenWeatherMap](https://openweathermap.org/api) | Weather | apiKey | True | unknown |
| [QWeather](https://dev.qweather.com/en/) | Location-based weather data | apiKey | True | yes |
| [RainViewer](https://www.rainviewer.com/api.html) | Radar data collected from different websites across the Internet |  | True | unknown |
| [Storm Glass](https://stormglass.io/) | Global marine weather from multiple sources | apiKey | True | yes |
| [Tomorrow](https://docs.tomorrow.io) | Weather API Powered by Proprietary Technology | apiKey | True | unknown |
| [US Weather](https://www.weather.gov/documentation/services-web-api) | US National Weather Service |  | True | yes |
| [Visual Crossing](https://www.visualcrossing.com/weather-api) | Global historical and weather forecast data | apiKey | True | yes |
| [weather-api](https://github.com/robertoduessmann/weather-api) | A RESTful free API to check the weather |  | True | no |
| [WeatherAPI](https://www.weatherapi.com/) | Weather API with other stuff like Astronomy and Geolocation API | apiKey | True | yes |
| [Weatherbit](https://www.weatherbit.io/api) | Weather | apiKey | True | unknown |
| [Yandex.Weather](https://yandex.com/dev/weather/) | Assesses weather condition in specific locations | apiKey | True | no |
